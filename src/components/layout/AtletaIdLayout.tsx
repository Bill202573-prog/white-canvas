...
interface AtletaIdLayoutProps {
  children: React.ReactNode;
}

export function AtletaIdLayout({ children }: AtletaIdLayoutProps) {
      ...
      <header className="sticky top-0 z-50 bg-white/95 dark:bg-slate-900/95 backdrop-blur border-b border-slate-200 dark:border-slate-800">
        <div className="container flex items-center justify-between h-14 px-4">
          ...
          <div className="flex items-center gap-3">
            <Link to="/atletaid/linkedin" className="flex items-center gap-2">
            ...
            {user && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => navigate('/atletaid/linkedin')}>
